...
Update Packages:<br>go get -u<br>
Purge:<br>go mod tidy<br>
Vendor Packages:<br>go mod vendor<br>
Build:<br>
OS Specific:<br>
go build -ldflags="-s -w" -mod vendor<br>
Windows x86_32:<br>
GOOS=windows GOARCH=386 go build -ldflags="-s -w" -mod vendor<br>
Windows x86_64:<br>
